...
Original file is located at
    https://colab.research.google.com/drive/1CtD72zu-P05ZmqjHzX2choLz02k7uYtK
"""
...
# def solve_shortest_path_lp(mdp: GridWorld):
...
#     vars_vec = cp.hstack(vars_list)            # shape (n_vars,)
#     costs_vec = np.array(costs_list)           # shape (n_vars,)
